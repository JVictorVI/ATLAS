...
let pendingCodeEditConfirmationElement = null;
...
let configuredLocalModelId = null;
let configuredCloudModelId = null;
let libraryHealth = null;
let libraryModels = [];
let isLocalEngineActionRunning = false;
let isLocalEngineSelectionRunning = false;
let pendingLocalEngineType = null;
let localEngineSelectionMessage = "";
let localEngineSelectionError = false;
